            ...
            <>
              ...
              <div className="space-y-2 rounded-xl border border-dashed border-neutral-400 bg-neutral-50 p-4 sm:p-6 text-sm text-neutral-800">
                ...
                <p className="text-xs text-neutral-600">
                  ...
                  Integrations should target v2 (`receipt-of-life-v2`) for all
                  features and fee safety.
                </p>
              </div>
              ...
              <div className="space-y-4 rounded-xl border border-black bg-white p-4 sm:p-6">
                ...
                <div className="mt-2 space-y-2 text-sm text-neutral-800">
                  <p>
                    ...
                    or tx-sender = TREASURY; ROYALTY-FEE skipped when fee = 0 or
              ...
              stats ? (
                <div className="space-y-3 text-sm text-neutral-800">
                  ...
                  <div>
                    ...
                    {config.royaltyFee} µSTX (≈ {config.royaltyFee / 1_000_000}{" "}
                    STX)
                  </div>
                  <div className="pt-2">
              ...
              {!isAdmin && (
                <div className="rounded-xl border border-black bg-white p-4 sm:p-6">
                  <p className="text-sm text-neutral-800">
                    You&apos;re connected as{" "}
                    <span className="font-mono">{shorten(address)}</span>, but
                    this is not the admin address. Only the admin can run
                    on-chain actions.
                  </p>
                </div>
              )}
